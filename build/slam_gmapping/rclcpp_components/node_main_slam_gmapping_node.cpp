...
#define NODE_MAIN_LOGGER_NAME "slam_gmapping_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libslam_gmapping.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<SlamGmapping>";
